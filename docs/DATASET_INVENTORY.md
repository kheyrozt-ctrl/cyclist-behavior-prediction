...
|---|---:|---:|---|---|
| `cyclistprediction/Full33SkeletonData/` | 226 | 256.86 MB | 226 CSV | MediaPipe-style 33-joint skeleton sequences |
| `cyclistprediction/GestureDataset/` | 618 | 3,011.24 MB | 392 CSV, 218 MP4, 5 PKL, 2 TXT, 1 XLSX | Raw/derived trial video, parsed telemetry, survey and label material |
| `cyclistprediction/Results/` | 41 | 3.21 MB | 21 NPY, 20 CSV | Derived labels, masks, and trajectory outputs |
...
`0cyclistprediction_v5` as the sole dataset source. The current release is
