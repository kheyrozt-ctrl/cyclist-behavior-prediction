...
class TrtPoseAdapter(PoseAdapter):
    ...
    Imports from the `open_source/pose_backends/trt_pose` backend for model loading, preprocessing,
    ...
    def __init__(self):
        # Add the TRT pose backend to path so we can import pose_detect.
