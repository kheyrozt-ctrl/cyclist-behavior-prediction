...
OPEN_SOURCE_DIR = os.path.abspath(os.path.join(SCRIPT_DIR, os.pardir, os.pardir))
INTERSECTION_RUNTIME_DIR = os.path.join(OPEN_SOURCE_DIR, "inference", "intersection_runtime")
if INTERSECTION_RUNTIME_DIR not in sys.path:
    sys.path.insert(0, INTERSECTION_RUNTIME_DIR)
