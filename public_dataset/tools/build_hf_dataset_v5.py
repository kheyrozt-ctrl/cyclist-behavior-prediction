...
SRC = REPO_ROOT / "open_source" / "training" / "bus_stop_v5_public"
...
OUT = DATASET_ROOT / "release" / "hf" / "cyclist-intention-2d-keypoints-v2"
KEY = DATASET_ROOT / ".release-secrets" / "vru_hmac.key"
...
'''
    ...
    manifest={"dataset":repo_id,"version":"2.0.0","source":"open_source/training/bus_stop_v5_public","stats":stats,"files":{}}
